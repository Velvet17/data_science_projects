...
| [15. Исследование энергозатрат при производстве стали](15_steel_production)	| Создал модель машинного обучения, которая определяет приблизительный возраст человека по фотографии.	| *Python, Pandas, Matplotlib, Seaborn, Exploratory data analysis, Data visualization, Data preprocessing, Math, Machine Learning, Gradient Boosting, Numpy* |
