...
| [11. Прогнозирование цен на автомобили](11_boosting)	| Обучили модель машинного обучения определять рыночную стоимость автомобиля.	| *Pandas, Sklearn, Numpy, LightGBM, машинное обучение, CatBoost, XGBoost* |
